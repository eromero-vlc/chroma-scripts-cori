...
"
	...
	baryon_chroma_max_tslices_in_contraction=1 # as large as possible (zero means do all time slices at once)
	baryon_chroma_max_moms_in_contraction=$(( prop_slurm_nodes*8 )) # as large as possible (zero means do all momenta at once)
	baryon_chroma_max_vecs=16 # as large as possible (zero means do all eigenvectors are contracted at once)
